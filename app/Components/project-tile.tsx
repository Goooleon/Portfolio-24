        ...
        <div
            ...
            {isLinkActive ? (
                <Link href={link} className="block">
                    <div className="absolute inset-0 z-10 flex px-6 md:px-10 items-center justify-center bg-black backdrop-blur-sm bg-opacity-70 opacity-0 hover:opacity-100 transition-opacity duration-300 ease-in-out">
